...
// Relations
db.collaborateur.belongsTo(db.manager, { foreignKey: "id_manager", targetKey: "id", as: "manager" });
db.manager.hasMany(db.collaborateur, { foreignKey: "id_manager", sourceKey: "id", as: "collaborateurs" });
